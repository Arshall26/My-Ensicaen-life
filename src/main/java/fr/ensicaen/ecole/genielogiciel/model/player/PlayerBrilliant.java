...
public class PlayerBrilliant extends PlayerModel {
    public PlayerBrilliant(int id, String username, ISquareModel square, SoftSkill softSkill, HardSkill hardSkill) {
